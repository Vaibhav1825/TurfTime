...
const AllBookings = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      //   }
      // };
      const response = await axios.get('http://localhost:8080/admin/allBookings');
          ...
          {bookings.map((booking) => (
            ...
            >
              ...
              <div className="relative z-10 p-4">
                ...
                <p className="text-n-3 mb-4">Email: {booking.email}</p>
                <p className="text-n-3 mb-4">Book at: {new Date(booking.createdAt).toLocaleDateString()}</p>
