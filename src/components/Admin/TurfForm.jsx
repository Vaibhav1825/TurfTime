...
const TurfForm = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:8080/admin/turfs', {
                name,
                description,
                location
            });
            ...
            <Section crosses>
                <div className="container relative z-2 max-w-[68rem] m-auto lg:flex lg:justify-between">
                    <div className="max-w-[32.875rem] mx-auto mb-12 text-center md:mb-16 lg:flex lg:flex-col lg:justify-around lg:max-w-[23.75rem] lg:m-0 lg:text-left">
                        <h2 className="h2">Add a New Turf to Your Inventory</h2>
                        <p className="hidden body-2 mt-4 text-n-4 md:block">Enter the details of your new turf, including its location, size, and features, to add it to your inventory and make it available for booking and management</p>
                    </div>
                    <form
                    ...
                    >
                        <div className="px-9 py-10 bg-n-8 rounded-[1.4375rem] lg:px-16 lg:py-[3.25rem]">
                            ...
                            <div className="relative mb-4 lg:mb-5">
                                <textarea
                                    className={`w-full h-24 pl-12 bg-transparent border-b border-n-1/15font-light placeholder:text-n-4 outline-none transition-colors`}
                            ...
                            <button
                                ...
                                type="submit"
                            >
                                <span className="relative z-10">Add turf</span>
